...
public class LoadInfo {
	...
	/*注意下面这些文件的地址是否有问题*/
	//可能需要更换这里的参数
	static String vmFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\vmInformation.txt");
	static String hostFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\hostInformation.txt");
	static String jobFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\allJobName.txt");
	static String jobBudgetFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\jobBudget.txt");
	static String jobDeadlineFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\jobDeadline.txt");
	static String jobEnergyFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\jobDataCenterEnergyRandAlgorithm.txt");
	static String jobMakespanFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\jobMakespan.txt");//matlab版本是makespan.txt
	static String jobCostFileName = new String("C:\\Users\\BALU KAKUMANU\\Desktop\\w\\tsp\\tsp-MOEA(v1)\\WorkflowSim-1.0-master\\examples\\TSPMOEA\\jobCost.txt");
